    ...
    bot.command('test', async (ctx) => {
        ...
        testInterval = setInterval(async () => {
            try {
                ...
                const imagePath = path_1.default.join(__dirname, '..', 'school21Hostel.png');
 ...
 */
async function processPayment(ctx, bot, userId, userState, fileId, fileType) {
    ...
    const paymentResponse = await axios_1.default.post(`${BACKEND_URL}/api/payments`, {
    ...
    await ctx.reply(`To'lov cheki qabul qilindi!\n\n` +
        `Ma'lumotlar:\n` +
...
//# sourceMappingURL=commands_old.js.map